...
(/** @lends <global> */function( $ ) {
	...
	function _fnScrollDraw ( settings )
	{
		...
		// If scroll collapse is enabled, when we set the headers back into the body for sizing, we
	...
	function _fnCalculateColumnWidths ( oSettings )
	{
		...
		else
		{
			...
			// Find the widest cell for each column and set it into the table
	...
	DataTable = function( options )
	{
		 ...
		 *  @param {string|node|jQuery} mHtml The HTML to set into the row
	...
	DataTable.models.oRow = {
		 ...
		 * on tableName for the nTr property.
		 *  @type string
		 *  @default <i>Empty string</i>
		 *  @private
		 */
