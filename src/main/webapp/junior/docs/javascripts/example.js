...
var HomeTemplate = [
  ...
  ' </header>',
  // Another Ratchet dispatcher, a fancy list divider.
...
var HomeView = Jr.View.extend({
  ...
  setUpCarousel: function() {
    ...
    // We have to set this in a setTimeout so that it sets it up after the view is added to the DOM
    setTimeout(after,1);
  },
...
// If you want the contents of the header to be animated as well, set those elements inside a div
