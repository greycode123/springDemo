...
(function ($) {
    ...
    var scroller = (function () {
        ...
        jsScroller.prototype.onTouchEnd = function (event) {
            ...
            var topOffest = Math.abs(scrollInfo.top - this.lastScrollInfo.top);
            if(topOffest <= 2){
                scrollInfo.y = this.lastScrollInfo.y;
            }

            var leftOffest = Math.abs(scrollInfo.left - this.lastScrollInfo.left);
            if(leftOffest <= 2){
                scrollInfo.x = this.lastScrollInfo.x;
            }
